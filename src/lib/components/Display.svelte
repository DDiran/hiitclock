...
<div class="my-24">
  <div class="flex flex-col md:flex-row gap-4 text-center justify-center">
    <div class="w-full md:w-8/12 lg:w-7/12 xl:w-8/12">
      <div
        class="card w-full h-full bg-base-400 shadow-xl flex flex-col animate:fly={{
          y: -20,
          duration: 300,
        }}">
        <div class="card-body flex-1">
          <h2
            class="card-title justify-center text-4xl font-serif font-normal in:fade={{
              duration: 200,
            }}">
          ...
          <div class="justify-center">
            <div class="text-[128px] animate:scale={{ duration: 300 }}">
    ...
    <div class="w-full md:w-4/12 lg:w-5/12 xl:w-4/12">
      <div
        ...
        <div class="card-body flex-1">
          <h2
            class="card-title justify-center text-2xl font-serif font-normal in:fade={{
              duration: 200,
            }}">
            Workout Progress
          </h2>
          ...
          <div class="justify-center mt-9">
            <div
              class="radial-progress animate:scale={{ duration: 300 }}"
